                    ...
                    <div class="container">
                        <div class="carousel-centered">
                            <div class="margin-b-40">
                                <h1 class="carousel-title">Привет</h1>
                                <p class="color-white">Сегодня мы вам роскажем <br/> Очень интересную историю</p>
                            </div>
                            <a href="#" class="btn-theme btn-theme-sm btn-white-brd text-uppercase">Посмотреть</a>
                        </div>
                    </div>
                </div>
                <div class="item">
